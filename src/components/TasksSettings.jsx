      ...
      {isCheckingInstallation ? (
        <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-muted-foreground">{t('tasksSettings.checkingInstallation')}</span>
          </div>
        </div>
      ) : (
        <>
                  ...
                  <div className="text-sm text-orange-800 dark:text-orange-200 space-y-3">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {t('tasksSettings.notInstalled.viewOnGitHub')}
                    ...
                    <div className="space-y-2">
                      <p className="font-medium">{t('tasksSettings.notInstalled.afterInstallation')}</p>
                      <ol className="list-decimal list-inside space-y-1 text-xs">
                        <li>{t('tasksSettings.notInstalled.step1')}</li>
                        <li>{t('tasksSettings.notInstalled.step2')}</li>
                        <li>{t('tasksSettings.notInstalled.step3')}</li>
                      </ol>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-foreground">
                      {t('tasksSettings.enableIntegration')}
                    </div>
                    <div className="text-sm text-muted-foreground mt-1">
                      {t('tasksSettings.enableDesc')}
                    </div>
                  </div>
